		...
		if(playing) {
			...
			$(".vinyl").each(function() {
				...
				$(this)
					...
					<audio id="player" controls autoplay="true"><source src="http://songs.nagafm.com:8006/;stream.mp3/ogg" type="audio/mp3" width="300">Your browser does not support the audio element.</audio>
			});
		} else {
			// Play
			<audio><source src="http://songs.nagafm.com:8006/;stream.mp3/ogg" type="audio/mp3" width="300">Your browser does not support the audio element.</audio>
